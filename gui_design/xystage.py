...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_x_num.setMinimumSize(QtCore.QSize(113, 0))
        ...
        self.label_y_num.setMinimumSize(QtCore.QSize(113, 0))
        ...
        self.label_x_offset = QtWidgets.QLabel(self.groupBox_experiment)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_x_offset.sizePolicy().hasHeightForWidth())
        self.label_x_offset.setSizePolicy(sizePolicy)
        self.label_x_offset.setMinimumSize(QtCore.QSize(113, 0))
        self.label_x_offset.setObjectName("label_x_offset")
        self.horizontalLayout_8.addWidget(self.label_x_offset)
        self.spinBox_y_num_2 = QtWidgets.QSpinBox(self.groupBox_experiment)
        self.spinBox_y_num_2.setMinimumSize(QtCore.QSize(60, 0))
        self.spinBox_y_num_2.setMinimum(-100)
        self.spinBox_y_num_2.setMaximum(100)
        self.spinBox_y_num_2.setProperty("value", 0)
        self.spinBox_y_num_2.setObjectName("spinBox_y_num_2")
        self.horizontalLayout_8.addWidget(self.spinBox_y_num_2)
        self.verticalLayout.addLayout(self.horizontalLayout_8)
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_11.setSizeConstraint(QtWidgets.QLayout.SetDefaultConstraint)
        self.horizontalLayout_11.setSpacing(6)
        self.horizontalLayout_11.setObjectName("horizontalLayout_11")
        self.label_y_num_4 = QtWidgets.QLabel(self.groupBox_experiment)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_y_num_4.sizePolicy().hasHeightForWidth())
        self.label_y_num_4.setSizePolicy(sizePolicy)
        self.label_y_num_4.setMinimumSize(QtCore.QSize(113, 0))
        self.label_y_num_4.setObjectName("label_y_num_4")
        self.horizontalLayout_11.addWidget(self.label_y_num_4)
        self.spinBox_y_num_3 = QtWidgets.QSpinBox(self.groupBox_experiment)
        self.spinBox_y_num_3.setMinimumSize(QtCore.QSize(60, 0))
        self.spinBox_y_num_3.setMinimum(-100)
        self.spinBox_y_num_3.setMaximum(100)
        self.spinBox_y_num_3.setProperty("value", 0)
        self.spinBox_y_num_3.setObjectName("spinBox_y_num_3")
        self.horizontalLayout_11.addWidget(self.spinBox_y_num_3)
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_x_offset.setText(_translate("Form", "x offset (-100 .. 100)"))
        self.label_y_num_4.setText(_translate("Form", "y offset (-100 .. 100) "))
