...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 191, 447))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.widget_motor_transmission = MotorWidget(self.scrollAreaWidgetContents)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.widget_motor_transmission.setMinimumSize(QtCore.QSize(0, 0))
        self.widget_motor_transmission.setObjectName("widget_motor_transmission")
        self.gridLayout_7.addWidget(self.widget_motor_transmission, 1, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 535, 476))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.widget_motor_excitation_emission = MotorWidget(self.scrollAreaWidgetContents_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.widget_motor_excitation_emission.sizePolicy().hasHeightForWidth())
        self.widget_motor_excitation_emission.setSizePolicy(sizePolicy)
        self.widget_motor_excitation_emission.setMinimumSize(QtCore.QSize(0, 0))
        self.widget_motor_excitation_emission.setObjectName("widget_motor_excitation_emission")
        self.gridLayout_8.addWidget(self.widget_motor_excitation_emission, 1, 0, 1, 1)
        ...
        self.plot_digitizer_decay = DigitizerPlotWidget(self.layoutWidget)
        self.plot_digitizer_decay.setMinimumSize(QtCore.QSize(200, 100))
        self.plot_digitizer_decay.setObjectName("plot_digitizer_decay")
        self.gridLayout_plot_decay.addWidget(self.plot_digitizer_decay, 0, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 120, 476))
        ...
        self.widget_motor_decay = MotorWidget(self.scrollAreaWidgetContents_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.widget_motor_decay.setMinimumSize(QtCore.QSize(0, 0))
        self.widget_motor_decay.setObjectName("widget_motor_decay")
        self.gridLayout_10.addWidget(self.widget_motor_decay, 1, 0, 1, 1)
